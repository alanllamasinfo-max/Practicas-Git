...
CREATE TABLE pruebas.departamentos (
...
CREATE TABLE pruebas.empleados (
    ...
    CONSTRAINT fk_departamento
        ...
        REFERENCES pruebas.departamentos(id_depto)
        ON DELETE SET NULL
);

-- 4. Insertamos datos de prueba en Departamentos
INSERT INTO pruebas.departamentos (nombre, ubicacion) VALUES 
('Recursos Humanos', 'Planta 1'),
('Tecnología', 'Planta 2'),
('Ventas', 'Planta Baja');

-- 5. Insertamos datos de prueba en Empleados
INSERT INTO pruebas.empleados (nombre, puesto, salario, fecha_contratacion, id_depto) VALUES 
...
CREATE VIEW pruebas.vista_empleados_info AS
SELECT 
...
FROM 
    pruebas.empleados e
LEFT JOIN 
    pruebas.departamentos d ON e.id_depto = d.id_depto;
